...
var require_protocol = __commonJS({
  "node_modules/vscode-languageserver-protocol/lib/common/protocol.js"(exports) {
    ...
    })(DidOpenTextDocumentNotification2 = exports.DidOpenTextDocumentNotification || (exports.DidOpenTextDocumentNotification = {}));
    ...
    })(DidCloseTextDocumentNotification2 = exports.DidCloseTextDocumentNotification || (exports.DidCloseTextDocumentNotification = {}));
...
var _EslintTask = class {
  constructor() {
    ...
    this.disposables.push(import_coc.commands.registerCommand(_EslintTask.id, async () => {
  ...
  dispose() {
    (0, import_coc.disposeAll)(this.disposables);
  }
};
var EslintTask = _EslintTask;
...
var probeFailed = /* @__PURE__ */ new Set();
...
function activate(context) {
  function didOpenTextDocument(textDocument) {
    ...
    if (computeValidate(textDocument) !== "off" /* off */) {
...
function realActivate(context) {
  ...
  function updateStatusBar(uri) {
    const status = function() {
      ...
      return (_a2 = uri !== void 0 ? documentStatus.get(uri) : void 0) != null ? _a2 : 1 /* ok */;
    }();
    let text = "ESLint";
    switch (status) {
      case 1 /* ok */:
  ...
  const clientOptions = {
    ...
    middleware: {
      didOpen: async (document, next) => {
        if (import_coc3.workspace.match([packageJsonFilter], document) || import_coc3.workspace.match([configFileFilter], document) || computeValidate(document) !== "off" /* off */) {
  ...
  import_coc3.workspace.registerAutocmd({
    ...
    callback: async (bufnr) => {
      ...
      if (!doc || !doc.attached)
        return;
      if (computeValidate(doc.textDocument) == "off" /* off */)
        return;
  ...
  import_coc3.workspace.onDidChangeConfiguration(() => {
    ...
    for (const textDocument of import_coc3.workspace.textDocuments) {
      if (!syncedDocuments.has(textDocument.uri.toString()) && computeValidate(textDocument) !== "off" /* off */) {
        try {
